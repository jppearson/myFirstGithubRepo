package SimpleCarPeter "A library to demonstrate models used in analyzing vehicle performance"
annotation (
  ...
  Window(
    ...
    library=1, 
    autolayout=1), 
  Documentation(info="The \"SimpleCarPeter\" package and all models contained in it
